  ...
  <div class="modal" transition:fade>
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <input type="text" bind:value={user.mobileNumber} />
      </div>
      <div class="form-group">
        <label>Company</label>
        <input type="text" bind:value={user.companies} />
      </div>
      ...
      <form on:submit|preventDefault={saveUser}>
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="mobileNumber" bind:value={user.mobileNumber} />
          </div>
          <div class="col-md-6 mb-3">
            <label for="companies" class="form-label">Company</label>
            <input type="text" class="form-control" id="companies" on:input={(e) => debouncedFilter(e.target.value)} bind:value={user.companies} placeholder="Search your company" />
            <ul class="suggestions">
              {#if filteredCompanies.length > 0}
                {#each filteredCompanies as company}
                  <li on:click={() => { user.companies = company.name; filteredCompanies = []; }}>{company.name}</li>
                {/each}
              {/if}
            </ul>
          </div>
