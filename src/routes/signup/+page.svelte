<script>
	...
	async function handleSubmit() {
		if (!name || !email || !address || !phoneNumber || !query) {
	...
	<div class="container">
		...
		<form on:submit|preventDefault={handleSubmit} method="POST">
			...
			<div>
				...
				<textarea id="address" placeholder="Enter your address" bind:value={address}></textarea>
			</div>
			<div>
				<label for="query">Query</label>
				<textarea id="query" placeholder="Write your query" bind:value={query}></textarea>
			</div>
...
<footer class="footer">
	<p class="textfoot">
		&copy; 2024 <a href="https://www.vestanam.com/">Vestanam Solutions Pvt. Ltd.</a> All rights reserved.
	</p>
</footer>
